...
# RUN wget --no-check-certificate https://download.opendesign.com/guestfiles/Demo/ODAFileConverter_QT5_lnxX64_7.2dll_22.12.rpm
RUN zypper --non-interactive in --no-recommends --allow-unsigned-rpm ODAFileConverter_QT5_lnxX64_7.2dll_21.11.rpm
# RUN zypper --non-interactive in --no-recommends --allow-unsigned-rpm ODAFileConverter_QT5_lnxX64_7.2dll_22.12.rpm
